    ...
    PHASE_SUMMARIES = {
        ...
        "6": {
            ...
            "content": [
                ...
                "Productivity & Communication Applications:",
                ...
                "Automation & System Enhancement Tools:",
        ...
        "7": {
            ...
            "content": [
                ...
                "  • Dedicated ML Environment (uv-managed):",
                "    - Project location: $XDG_DATA_HOME/python-projects/ml-dev",
                "    - Python 3.12 runtime with comprehensive ML packages",
                "    - Dependencies from HRT template: ml-dev-pyproject.toml",
                "    - Essential packages: numpy, pandas, scikit-learn, tensorflow, pytorch",
                "    - Data science tools: jupyter, matplotlib, seaborn, plotly",
                "    - ML libraries: transformers, datasets, tokenizers, accelerate",
                "  • Jupyter Integration:",
                "    - Custom kernel registered: 'Python (ML-Dev-UV)'",
                ...
                "    - 'Python (ML-Dev-UV)' for machine learning development",
                "    - 'Python (Agentic-AI-UV)' for AI agent development"
            ]
        }
    }
